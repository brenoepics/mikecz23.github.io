...
export default defineConfig({
  ...
  ssr: { noExternal: ['element-plus', /\.css$/, /\.vue$/, /^vitepress-carbon/, /^vitepress/, '@docsearch/css']
    },
  css: {
    postcss: {
      plugins: [
