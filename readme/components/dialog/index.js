...
export default class Dialog extends Base {
      ...
      <dialog class="dialog" id="dialog" part="dialog">
        ...
        <form class="form" method="dialog">
          ...
          <slot class="footer" name="footer" part="footer">
            <xy-button id="btnCancel" type="flat" close>Zavřít</xy-button>
            <xy-button id="btnSubmit" type="primary">Odeslat</xy-button>
          </slot>
        </form>
      </dialog>
        `;
  ...
  get loading() {
	...
	get submittext() {
		return this.getAttribute("submittext") || "Odeslat";
	}

  get canceltext() {
		return this.getAttribute("canceltext") || "Zavřít";
	}
...
Dialog.open = function({
  ...
  if (type !== 'confirm') {
    ...
    dialog.submittext = submittext || 'Zavřít';
  } else {
    dialog.submittext = submittext || 'Tak určitě';
  }
